$(window).on('load', function () {
    ...
    $("#combo2").click(function () {
        $('head').append('<link rel="stylesheet" type="text/css" href="assets/frontend/educomp/v2.1/css/style-blue.css">');
        $('head').append('<link rel="stylesheet" type="text/css" href="assets/frontend/educomp/v2.1/css/components-blue.css">');
    });
