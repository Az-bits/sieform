...
class Backend extends MY_Controller
{
	...
	public function render()
	{
		...
		// Include nav header
		$this->data['header'] = $this->parser->parse('backend/_theme/header', $this->data, TRUE);

		$this->data['page'] = $this->data['page'];
		// Include navside
		$this->data['menu'] = $this->parser->parse('backend/_theme/menu', $this->data, TRUE);
...
class Frontend extends MY_Controller
{
	public function __construct()
	{
		...
		// Title
		$this->data['title'] = (!empty($this->config->item('dp_title'))) ? $this->config->item('dp_title') : 'SIE';
	}
	...
	public function render()
	{
		...
		// Include nav header
		$this->data['header'] = $this->parser->parse('frontend/_theme/header', $this->data, TRUE);
		...
		// Include nav header
		$this->data['footer'] = $this->parser->parse('frontend/_theme/footer', $this->data, TRUE);
		// Render Template
		$this->data['data'] = &$this->data;
