			...
			<div class="col-12 col-md-12">
				<center>
					...
					<div class=" col-md-6 alert alert-warning alert-with-icon" data-notify="container">
						...
						<span data-notify="message" style="display: flex;align-items: center;">Todo cambio esta sujeto bajo su Responsabilidad.<i style="color: white" class="material-icons">warning</i></span>
					</div>
				</center>
			</div>
		</div>
