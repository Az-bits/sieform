<form id="formulario_modal" method="post" action="<?= base_url(Hasher::make(92)) ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="selectpicker" data-style="btn btn-primary btn-round" data- title="Seleccione" name="id_tipo_publicacion" id="tipo">
                        </select>
                    </div>
                </div>
                <div class="col-lg-5">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail img-raised">
                                        ...
                                        <img src="https://glouton.b-cdn.net/site/images/no-image-wide.png" id="preViewImage" rel="nofollow" alt="...">
                                    </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="f_i" name="fecha_inicio" class="form-control datepicker" placeholder="mm-dd-aaaa">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <div class="form-group">
                                <label class="form-check-label">
                                    Publicar <input name="visibilidad" class="form-check-input" type="checkbox" value="1">
